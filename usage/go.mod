...
require (
	...
	github.com/tendermint/tm-db v0.6.1 // indirect
...
replace (
	...
	github.com/ontio/ontology-go-sdk => github.com/blockchain-develop/ontology-go-sdk v1.11.5-0.20200814114946-6e50cfa5a644
)
