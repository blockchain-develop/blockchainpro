...
func TestDeployContract(t *testing.T) {
	...
	hash, err := layer2_sdk.NeoVM.DeployNeoVMSmartContract(0, 20000, account_operator, true,
...
func TestInvokeContract(t *testing.T) {
	layer2_sdk := newLayer2Sdk()
	account_operator, _ := newLayer2OperatorAccount(layer2_sdk)
	contractAddress, _ := ontology_common.AddressFromHexString("")
	tx, err := layer2_sdk.NeoVM.NewNeoVMInvokeTransaction(0, 20000, contractAddress, []interface{}{"Hello", []interface{}{"this is example"}})
	if err != nil {
		panic(err)
	}
